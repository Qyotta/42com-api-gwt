...
public class Html5HistorianImpl implements Html5Historian {
   ...
   private native void bind() /*-{
      ...
      var f = function(event) {
         ...
         that.@de.qyotta.fourtytwocom.api.example.client.init.history.Html5HistorianImpl::onPopState(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(data, event.title, event.url);
   ...
   // called from js
   protected void onPopState(final String data, final String title, final String url) {

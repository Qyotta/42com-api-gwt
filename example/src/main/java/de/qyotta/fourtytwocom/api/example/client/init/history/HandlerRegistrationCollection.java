...
public class HandlerRegistrationCollection implements HandlerRegistration, com.google.web.bindery.event.shared.HandlerRegistration {
   ...
   private final LinkedList<com.google.web.bindery.event.shared.HandlerRegistration> collectedHandlers = new LinkedList<com.google.web.bindery.event.shared.HandlerRegistration>();
    ...
    *           the handlerregistration to add
    */
   public void addHandlerRegistration(final HandlerRegistration handlerRegistration) {
      collectedHandlers.add(handlerRegistration);
   }

   public void addHandlerRegistration(final com.google.web.bindery.event.shared.HandlerRegistration handlerRegistration) {
      collectedHandlers.add(handlerRegistration);
   }
   ...
   public void removeHandler() {
      for (final com.google.web.bindery.event.shared.HandlerRegistration handlerRegistration : collectedHandlers) {
